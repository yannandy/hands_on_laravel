            ...
            <div class="contain" style="width: 100%;">
                <div class="information_and_button" style="margin:5% 0px">
                    <div class="contain_partner_info" style="display: grid; grid-template-columns: 0.4fr 0.8fr; gap:3%">
                        <img src="Wallpaper/jac/gift-habeshaw-QDP10NbwcyE-unsplash.jpg" alt="logo_entreprise" style="width: 100%;">
                        <div class="real_information">
                            ...
                            <div class="description">
                                <p class="description_de_entreprise">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae voluptatibus, accusamus ut in, maxime fugiat veniam eos reiciendis facere, cupiditate sapiente quidem officia nemo? Illum tenetur qui placeat inventore iusto?
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="information_and_button" style="margin:5% 0px">
                    <div class="contain_partner_info" style="display: grid; grid-template-columns: 0.4fr 0.8fr; gap:3%">
                        <img src="Wallpaper/jac/tony-rojas-lk5MYKmGyFE-unsplash.jpg" alt="logo_entreprise" style="width: 100%;">
                        <div class="real_information">
                            <div class="nom_prenom" style="display: flex;">
                                <span style="font-size: 20px; margin-right: 5%;"><i class="fas fa-user"></i></span>
                                <p class="nom_directeur" style="margin-right: 2%;">ABALLO</p>
                ...
                <div class="information_and_button" style="margin:5% 0px">
                    <div class="contain_partner_info" style="display: grid; grid-template-columns: 0.4fr 0.8fr; gap:3%">
                        <img src="Wallpaper/jac/redd-9o8YdYGTT64-unsplash.jpg" alt="logo_entreprise" style="width: 100%;">
                        <div class="real_information">
                            <div class="nom_prenom" style="display: flex;">
                                <span style="font-size: 20px; margin-right: 5%;"><i class="fas fa-user"></i></span>
                                <p class="nom_directeur" style="margin-right: 2%;">ABALLO</p>
                ...
                <div class="information_and_button" style="margin:5% 0px">
                    <div class="contain_partner_info" style="display: grid; grid-template-columns: 0.4fr 0.8fr; gap:3%">
                        <img src="Wallpaper/jac/joshua-eckstein-S84mDHGATw0-unsplash.jpg" alt="logo_entreprise" style="width: 100%;">
                        <div class="real_information">
                            <div class="nom_prenom" style="display: flex;">
                                <span style="font-size: 20px; margin-right: 5%;"><i class="fas fa-user"></i></span>
                                <p class="nom_directeur" style="margin-right: 2%;">ABALLO</p>
