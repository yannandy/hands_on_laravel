...
<nav class="navbar navbar-expand-sm bg-light" style="display: grid; grid-template-columns: 0.2fr 1fr 0.2fr;">
        ...
        <div class="contain_sidebar_temoignage" style="display: flex; flex-direction: row;">
            ...
            <div class="contain" style="width: 100%; margin: 0px 5%;">
                <div class="information_and_button" style="margin:5% 0%">
                    <div class="contain_partner_info" style="display: grid; grid-template-columns: 0.4fr 0.8fr; gap:3%">
                        <img src="Wallpaper/jac/tony-rojas-lk5MYKmGyFE-unsplash.jpg" alt="logo_entreprise" style="width: 100%; border-radius: 40%;">
                        <div class="real_information">
                            ...
                            <div class="partner_entreprise">
                                <p class="nom_de_entreprise"><span style="font-size: 20px; margin-right: 5%;"><i class="fas fa-hotel"></i></span>ADMINISTRATEUR</p>
                            </div>
                            <div class="contact">
                    ...
                    <div class="dismiss_accept_button" style=" display: flex; gap: 5%; margin:2% 30%;">
                        <button type="button" class="btn btn-success"><i class="fas fa-edit">MODIFIER PROFIL</i></button>
                    </div>
                </div>
